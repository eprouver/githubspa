...
export function create(req, res) {
  ...
  if(req.body.head_commit.author.email.toLowerCase().indexOf('microsoft.com') > -1){
    return Thing.create({
      name: req.body.head_commit.author.name,
      email: req.body.head_commit.author.email,
      timestamp: req.body.head_commit.timestamp,
      username: req.body.head_commit.author.username,
    ...
    ThingEvents.emit('nosave');
    return res.status(200).json({msg: 'created not saved'})
